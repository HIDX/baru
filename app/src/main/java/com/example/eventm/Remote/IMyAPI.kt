...
interface IMyAPI {
    @FormUrlEncoded
    @POST ("register")
    fun registerUser(@Field("name")username:String,@Field("user_phone_number")numberPhone:String,@Field("user_email")email: String,@Field("user_password")password: String):Call<APIresponse>
